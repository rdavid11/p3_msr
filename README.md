...
Gasto Parcial (Brazo): Cae prácticamente a cero. El brazo está en posición de reposo, consumiendo únicamente el par mínimo necesario para mantener su postura frente a la gravedad mientras la base móvil se desplaza.

Fase 3: Manipulación del cubo azul sobre el rojo (170s - 200s)

Gasto Parcial (Brazo): Se registra el mayor pico de esfuerzo de toda la prueba, superando el valor de 2500 en la sumatoria absoluta. Esta fase es la más exigente mecánicamente: el brazo debe extenderse lateralmente, agarrar el cubo azul, levantarlo y calcular una trayectoria de evasión de colisiones para depositarlo con precisión sobre el cubo rojo.
